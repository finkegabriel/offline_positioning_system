...
ee.Authenticate()
ee.Initialize(project='orobytes-55fe6')
geolocator = Nominatim(user_agent="finkegabriel@gmail.com") #specify here
...
def main(lon, lat):
  ...
  'scale': 10
    ...
    print(path)
    urls = [path]
    wget.download('/Users/sync/code/offline_system', urls[0], filenames='x.zip', extract=True) #path to your location to save a particular image
main(lon ,lat)