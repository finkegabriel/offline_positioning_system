...
ee.Authenticate()
ee.Initialize(project="orobytes-85a8e")
geolocator = Nominatim(user_agent="gabriel.finke98@gmail.com") #specify here
...
def main(lon, lat):
  ...
  'scale': 10
    ...
    print(path)
    urls = [path]
    wget.download('.', urls[0], 'x.zip') #path to your location to save a particular image
main(lon ,lat)
